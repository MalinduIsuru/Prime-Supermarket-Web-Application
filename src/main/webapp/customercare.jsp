    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Customer Care Center - <b>Prime Supermarket</b>
                    ...
                    <div class="card-body">
                        <div>
                                <h5>
            Welcome to Prime Supermarket's Customer Care Center! Your satisfaction is our top priority, 
            ...
            Feel free to explore the various ways you can connect with us and the services we offer.
                            ...
                            <div class="myDiv">
                            <img alt="" src="Images/prime1.png" width="300px">
                            </div>
                            <br>
                            <br>
                            ...
                            <div>
                                <strong>2. Email Support:</strong><a href="#" style="font-size: 20px; color: blue;"> primesupermarket24x7@gmail.com</a>
                            ...
                            <strong>4. Connect with Our Team Members:</strong> 
                           	<div>
                           	<ul class="divpl">
                            	<li>Malindu : 071 6419133</li>
                            	<li>Pinsara : 078 7175223</li>
                            	<li>Tharushi: 077 4256386</li>
                            	<li>Anjana  : 071 3083163</li>
                            	<li>Jayashan: 075 0684121</li>
                            	<li>Pabindu : 075 0684121</li>
                            </ul>
                           	</div>
                            ...
                            <strong>4. In-Store Assistance:</strong> Visit our physical store, and our staff will be happy to assist you with any questions or concerns.
                       		...
                       		<div>
                       		<h4>Thank You!</h4>
                       		<p>We appreciate your trust in choosing Prime Supermarket for your daily shopping needs. Our Customer Care team is here to ensure that your journey with us is smooth, enjoyable, and environmentally conscious. Thank you for being a part of our commitment to a healthier future!</p>
                       		</div>
